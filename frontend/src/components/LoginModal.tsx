...
const LoginModal = () => {
  ...
  return (
    <div className="h-screen w-screen fixed backdrop-blur-md inset-0 flex justify-center items-center">
      <div className="w-2/5 h-4/5 border border-slate-600 rounded-md bg-[#121212] flex flex-col gap-8 items-center">
        ...
        <div className="w-full flex flex-col gap-6 items-center">
            <div className="flex items-center h-11 w-3/5 border border-slate-500 rounded-sm">
                ...
                <input className="w-full h-full p-1 px-4 text-slate-200 placeholder:text-slate-400
                    bg-[#252424] rounded-md focus:outline-0" type="email" placeholder="Enter email"
